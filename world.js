const SCENES = [
  ...
  { speaker:'Lairus', sprite:'sprite-lairuss.png', cg:'bg-offices.png', text:'Agent Klara Dela Flora is dead. She is a casualty of another anomalous entity back at Folier\'s Inn, the Point Zero of the Dimension you sent them to.' },
  { speaker:'Maria', sprite:'sprite-marias.png', cg:'bg-offices.png', text:'.. y..you mean the kid.' },
  { speaker:'Lairus', sprite:'sprite-lairuss.png', cg:'bg-offices.png', text:'I will not further disclose any other information about our agents and other classified events.' },
  { speaker:'Maria', sprite:'sprite-marias.png', cg:'bg-offices.png', text:'Those. Are… my friends…..They. Told me things. Stories. About DSS.' },
  { speaker:'Lairus', sprite:'sprite-lairuss.png', cg:'bg-offices.png', text:'Well, pardon me, Miss Willows. But from what you just said, you had proven that these agents had breached our Society\'s Protocols.' },
  { speaker:'Maria', sprite:'sprite-marias.png', cg:'bg-offices.png', text:'.. They said something about you too– if you don\'t believe me– you can check the website again. All of the things they told me are there.' },
  { speaker:'Lairus', sprite:'sprite-lairuss.png', cg:'bg-offices.png', text:'There is no need.' },
